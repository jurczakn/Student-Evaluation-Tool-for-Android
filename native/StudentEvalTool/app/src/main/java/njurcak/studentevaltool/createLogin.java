...
public class createLogin extends ActionBarActivity {
    ...
    public void save(View view) {
        ...
        new postAddTeacher().execute(fname.getText().toString(), lname.getText().toString(), username.getText().toString(), password.getText().toString());

        status.setText(responseText);
    }
        private class postAddTeacher extends AsyncTask<String, Integer, Double> {
